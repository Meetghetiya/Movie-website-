...
#      movie_details = get_movie_details(page)
    
#      if request.method == 'POST':
#          next_page = page + 1
#          movie_details.append(get_movie_details(next_page))
#          return render(request, 'movielist.html', {'movie_details': movie_details, 'next_page': next_page + 1})
    
#      return render(request, 'movielist.html', {'movie_details': movie_details, 'next_page': page + 1})
